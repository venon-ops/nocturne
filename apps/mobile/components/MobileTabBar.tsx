...
const s=StyleSheet.create({bar:{position:'absolute',left:18,right:18,height:70,paddingHorizontal:7,paddingVertical:6,flexDirection:'row',alignItems:'stretch',borderWidth:1,borderColor:'rgba(168,136,255,.2)',borderRadius:24,backgroundColor:'rgba(15,18,31,.97)',shadowColor:'#000',shadowOffset:{width:0,height:8},shadowOpacity:.42,shadowRadius:18,elevation:16,overflow:'hidden'},slider:{position:'absolute',left:7,top:6,bottom:6,borderRadius:18,backgroundColor:'rgba(83,246,212,.065)',borderWidth:1,borderColor:'rgba(83,246,212,.1)'},tab:{position:'relative',zIndex:1,width:'25%',alignItems:'center',justifyContent:'center',borderRadius:18},pressed:{opacity:.58,transform:[{scale:.97}]},iconWrap:{height:25,alignItems:'center',justifyContent:'center'},iconActive:{transform:[{translateY:-1}]},label:{color:'#74798E',fontSize:9.5,fontWeight:'700',letterSpacing:.1,marginTop:2},labelActive:{color:'#F8F7FF',fontWeight:'900'}});
